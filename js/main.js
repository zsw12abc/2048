    ...
    for (var i = 0; i < 4; i++) {
        for (var j = 0; j < 4; j++) {
            ...
            if (board[i][j] === 0) {
                ...
                numberOfCell.css("top", getPosTop(i, j) + standL/5);
                numberOfCell.css("left", getPosLeft(i, j) + standL/5);
            } else {
                numberOfCell.css("width", standL/5);
                numberOfCell.css("height", standL/5);
